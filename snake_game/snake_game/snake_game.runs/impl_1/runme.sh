...
HD_PWD='C:/Users/ddddd/OneDrive/Desktop/Semester 3/DLD/Project/Two-Player-Snake/snake_game/snake_game/snake_game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_Game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Master_Game.tcl -notrace
