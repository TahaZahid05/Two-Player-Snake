...
HD_PWD='C:/Users/ddddd/OneDrive/Desktop/Semester 3/DLD/Project/Two-Player-Snake/snake_game/snake_game/snake_game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_Game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Master_Game.tcl
