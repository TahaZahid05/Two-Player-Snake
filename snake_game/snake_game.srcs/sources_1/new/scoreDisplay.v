    ...
    if (score_snake_one + score_snake_two == 4'd0) begin
        if (((horizontal_addr[9:2] >= pos_x_start && horizontal_addr[9:2] <= pos_x_end) && 
            ...
            ((horizontal_addr[9:2] == pos_x_start || horizontal_addr[9:2] == pos_x_end) && 
                (vertical_addr[8:2] > pos_y_start && vertical_addr[8:2] < pos_y_end))) // Left and right vertical lines
            colour <= colour_in;
    end 
        ...
        if ((horizontal_addr[9:2] == pos_x_start && vertical_addr[8:2] == (pos_y_start+3)) || (horizontal_addr[9:2] == (pos_x_start+1) && vertical_addr[8:2] == (pos_y_start + 2))
            || (horizontal_addr[9:2] == pos_x_end && vertical_addr[8:2] >= pos_y_start && vertical_addr[8:2] <= pos_y_end))
            colour <= colour_in;
    end
        ...
        if (((horizontal_addr[9:2] >= pos_x_start && horizontal_addr[9:2] <= pos_x_end) && 
                    ...
                    ((horizontal_addr[9:2] == pos_x_start && vertical_addr[8:2] >= (pos_y_start+5) && vertical_addr[8:2] < pos_y_end)))  // Bottom left vertical
            colour <= colour_in;
    end
        ...
        if (((horizontal_addr[9:2] >= pos_x_start && horizontal_addr[9:2] <= pos_x_end) && 
                    (vertical_addr[8:2] == pos_y_start || vertical_addr[8:2] == (pos_y_start+5) || vertical_addr[8:2] == pos_y_end)) || // Top, middle, bottom lines
                    (horizontal_addr[9:2] == pos_x_end && vertical_addr[8:2] > pos_y_start && vertical_addr[8:2] < pos_y_end))  // Right vertical line
            colour <= colour_in;
    end
        ...
        if (((horizontal_addr[9:2] == pos_x_start || horizontal_addr[9:2] == pos_x_end) && 
                    ...
                    vertical_addr[8:2] > (pos_y_start+5) && vertical_addr[8:2] <= pos_y_end))  // Middle horizontal line
            colour <= colour_in;
    end
        ...
        if (((horizontal_addr[9:2] >= pos_x_start && horizontal_addr[9:2] <= pos_x_end) && 
                    ...
                    ((horizontal_addr[9:2] == pos_x_end && vertical_addr[8:2] >= (pos_y_start+5) && vertical_addr[8:2] < pos_y_end)))  // Bottom right vertical
            colour <= colour_in;
    end
        ...
        if (((horizontal_addr[9:2] >= pos_x_start && horizontal_addr[9:2] <= pos_x_end) && 
            ...
            ((horizontal_addr[9:2] == pos_x_start || horizontal_addr[9:2] == pos_x_end) && 
            (vertical_addr[8:2] >= pos_y_start && vertical_addr[8:2] <= (pos_y_start + 5))) || // Left and right vertical lines (top half)
            (horizontal_addr[9:2] == pos_x_end && vertical_addr[8:2] >= (pos_y_start + 5) && vertical_addr[8:2] <= pos_y_end))  // Right vertical line (bottom half)
            colour <= colour_in;
    end
    else begin
        if (((horizontal_addr[9:2] >= pos_x_start && horizontal_addr[9:2] <= pos_x_end) && 
